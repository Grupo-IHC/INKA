...
export const Footer = () => {
  return (
    <footer>
      <div className='container mx-auto py-5 px-16 2xl:py-10 2xl:px-0'>
        <div className='flex justify-between'>
          <img className='w-2/12 2xl:w-auto' src={logoInkaFooter} alt="LogoInka" />
          <div className='flex items-center'>
            <img className='w-2/12' src={homeVector} alt="Home" />
            <span className='font-inka font-semibold text-base ml-2 w-full'>
              Jr. Maximo Gorbitz 889 Zona D
            </span>
          </div>
          <div className='flex items-center'>
            <img className='w-2/12' src={emailVector} alt="Email" />
            <span className='font-inka font-semibold text-base ml-2'>
          ...
          <div className='icons flex items-center gap-x-4'>
            <a href="https://www.youtube.com/watch?v=XVOBVbm3FJg" target='blank'>
              <img className='w-10/12' src={fbIcon} alt="Facebook" />
            </a>
            <a href="https://www.youtube.com/watch?v=XVOBVbm3FJg" target='blank'>
              <img className='w-10/12' src={igIcon} alt="Instagram" />
            </a>
            <a href="https://www.youtube.com/watch?v=XVOBVbm3FJg" target='blank'>
              <img className='w-10/12' src={ytIcon} alt="Youtube" />
            </a>
          </div>
        </div>
