...
export const ProductPageEdit = () => {
  ...
  return (
    <section className="Product">
      <div className="container mx-auto px-[15px] py-[15px] flex flex-col gap-y-[20px]">
        <h1 className="font-bold text-[#2B1E0C] text-[20px] text-center">SELLO 4910</h1>
        <p className="text-[16px] text-justify">Lorem ipsum dolor sit amet consectetur. Scelerisque tortor aliquam eu pretium </p>
        <div className="flex justify-center">
          <img src={imgPrueba} className="w-[70%]" alt="imgPrueba" />
        </div>
        ...
        <div className="content-medida">
          ...
          <div className="w-full h-[100px] bg-[#F2EEEE] flex items-center justify-center p-[15px] mt-[10px]">
            <p className="font-bold">26 x 9 mm</p>
          </div>
        </div>
        ...
        <div className="content-precio flex justify-between items-end">
          ...
          <h3 className="font-bold text-[20px]">S/ 20.00</h3>
        </div>
