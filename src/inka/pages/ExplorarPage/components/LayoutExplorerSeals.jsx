...
export const LayoutExplorerSeals = () => {
  return (
    <div className="py-7 px-4 rounded-lg grid grid-cols-3 2xl:grid-cols-4 gap-x-20 gap-y-10">
      <div className="bg-transparent border-2 rounded-3xl p-4 gap-y-5 flex flex-col">
