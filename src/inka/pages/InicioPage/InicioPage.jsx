...
export const InicioPage = () => {
  ...
  return (
    <>   
      <section className='section-1 h-[667px] 2xl:h-screen bg-mobile bg-cover'>
        <div className='container flex flex-col justify-center px-[15px] mx-auto text-white h-full relative lg:py-3.5 lg:px-16 2xl:px-0'>
          ...
          <p className='absolute left-[0] bottom-[4%] md:left-[2%] font-inika font-bold text-center lg:text-lg 2xl:text-2xl absolute lg:bottom-10 2xl:bottom-40 lg:left-14 2xl:left-1' style={containerStyle}> Empresa con una rica historia en la industria de sellos personalizados en Lima, Perú.</p>
        </div>
      </section>
      <section className='section-2 bg-white min-h-[230px] bg-section2 bg-cover md:bg-no-repeat'>
        <div className='container mx-auto px-[30px] py-[15px] md:py-[30px] lg:py-16 lg:px-16 2xl:py-20 2xl:px-0'>
            <h2 className='text-center font-stick font-bold text-secondary text-[16px] md:text-[18px] lg:text-3xl 2xl:text-5xl'>DEJA TU  HUELLA EN CADA PAGINA</h2>
      ...
      <section className='section-3 bg-white'>
        <div className='container mx-auto px-[30px] py-[30px] flex justify-center flex-col gap-y-[30px]'>
            <div className='sealWood flex justify-center gap-x-[40px] md:gap-x-[100px] lg:flex-col gap-y-4 2xl:gap-y-10'>
            ...
            <div className='sealAutomaic flex justify-center gap-x-[40px] md:gap-x-[100px] lg:flex-col gap-y-4 2xl:gap-y-10'>
      ...
      <section className='section-4 bg-section4 h-[520px] bg-cover bg-center md:h-[400px]'>
