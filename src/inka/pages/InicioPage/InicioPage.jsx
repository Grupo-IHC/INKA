    ...
    <>   
      <section className='section-1 h-[667px] 2xl:h-screen bg-mobile lg:bg-inicio bg-cover'>
        <div className='container flex flex-col justify-center px-[15px] mx-auto text-white h-full relative lg:py-3.5 lg:px-16 2xl:px-0'>
          ...
          <p className='absolute left-[0] bottom-[4%] md:left-[2%] font-inika font-bold text-center lg:text-lg 2xl:text-2xl absolute lg:bottom-10 lg:left-14 2xl:left-1' style={containerStyle}> Empresa con una rica historia en la industria de sellos personalizados en Lima, Perú.</p>
        </div>
      </section>
      <section className='section-2 bg-white h-[280px] md:h-[250px] bg-section2 bg-cover md:bg-no-repeat 2xl:h-[350px] 2xl:bg-center'>
        <div className='container mx-auto px-[30px] py-[15px] md:py-[30px] 2xl:h-[70%] 2xl:w-[50%] 2xl:flex 2xl:flex-col 2xl:justify-center'>
      ...
      <section className='section-4 bg-section4 h-[500px] bg-cover bg-center md:h-[400px] 2xl:h-[600px]'>
        <div className='container mx-auto px-[30px] py-[30px] justify-end h-[80%] md:h-[100%] md:justify-center flex flex-col gap-y-6 2xl:w-[70%]'>
