...
export const InicioPage = () => {
  ...
  return (
    <>   
      ...
      <section className='section-2 bg-section2-1'>
        <div className='container mx-auto px-[15px] py-[15px] lg:py-16 lg:px-16 2xl:py-20 2xl:px-0'>
            <h2 className='text-center font-stick font-bold text-secondary text-[18px] lg:text-3xl 2xl:text-5xl'>DEJA TU  HUELLA EN CADA PAGINA</h2>
      ...
      <section className='section-3 bg-white'>
        <div className='container mx-auto px-[15px] py-[15px] flex justify-center flex-col gap-y-[30px]'>
      ...
      <section className='section-4 bg-[#d1c8c1]'>
        <div className='container mx-auto px-[15px] py-[15px] flex flex-col gap-y-6 2xl:gap-y-14'>
